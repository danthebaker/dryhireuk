...
var settings = {
	...
	rackspace_username:process.env.RACKSPACE_USERNAME,
	rackspace_apikey:process.env.RACKSPACE_APIKEY,
	rackspace_region:process.env.RACKSPACE_REGION,
	rackspace_container:process.env.RACKSPACE_CONTAINER,
	rackspace_folder:process.env.RACKSPACE_FOLDER,
	rackspace_cdn:process.env.RACKSPACE_CDN,
